      ...
      <div className="relative z-10 container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            {/* CTA Buttons */}
            <div className={`flex flex-wrap gap-4 pt-4 ${isAr ? "flex-row-reverse" : ""}`}>
              ...
              <button className="flex items-center gap-2 px-8 py-4 bg-white/5 text-white font-semibold rounded-full border border-white/10 backdrop-blur-md transition-colors hover:bg-white/10">
                <div className="w-6 h-6 flex items-center justify-center rounded-full bg-white/10">
                  <Play className={`w-2.5 h-2.5 fill-white ml-0.5 ${isAr ? "rotate-180" : ""}`} />
                </div>
                {t.ctaSecondary}
              </button>
            </div>
          ...
          <div className="relative group animate-fade-in delay-300">
            ...
            <div className="relative p-8 md:p-12 rounded-[40px] bg-white/5 border border-white/10 backdrop-blur-2xl shadow-2xl">
              ...
              <div className="relative space-y-8">
                ...
                >
                  <div className="w-16 h-16 flex items-center justify-center rounded-3xl bg-blue-500/20 border border-blue-400/30">
                    <Target className="w-8 h-8 text-blue-400" />
                  </div>
                  <div>
                    <h3 className="text-3xl font-bold text-white tracking-tight">150+</h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden border border-white/5">
                    <div className="h-full w-[98%] bg-gradient-to-r from-blue-500 to-purple-500 rounded-full" />
                  </div>
                </div>
              ...
              <div className="relative flex overflow-hidden">
                <div className="flex animate-marquee gap-12 items-center whitespace-nowrap px-6">
                  {[...CLIENTS, ...CLIENTS, ...CLIENTS].map((client, i) => (
                    <div key={i} className="flex items-center gap-3 group/brand cursor-default">
